	...
	<div class="securityAddUser">
		<n-form class="layout1">
			<n-form-section>
				...
				<n-form-switch v-timeout:input="validate" v-model="setPassword" label="Set password?"/>
				<n-form-text v-timeout:input="validate" v-if="setPassword" type="password" :required="setPassword" v-model="password1" label="Password"/>
				<n-form-text v-timeout:input="validate" v-if="setPassword" type="password" :required="setPassword" v-model="password2" label="Password Again"/>
